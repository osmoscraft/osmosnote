...
:backlog:
* TODO onbeforeunload warn unsaved notes
* TODO capture new note from url using command with multiple heading options
* TODO debug window build bin output
...
* TODO generate bookmarklet from the app
* TODO clean up command system architecture
  ** TODO Disentangle option update vs. execution
