...
* Backlog
  ...
  ** Bugs
    - Links no longer interactive for mouse
    ...
    - Newly opened window won't receive focus (for some but not all commands)
    - Sometimes, insert created note after save will insert the wrong ID (end up being current note's ID)
...
* DONE command bar verticle overflow
* DONE When repo is empty, all commands throw error
