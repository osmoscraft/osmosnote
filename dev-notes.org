* TODO replace contenteditable with textarea
** TODO Delete from end of line is broken
** TODO Cursor position is borken after formatting
** TODO cannot hit Enter in the middle of text (trimming too greedy)
** TODO Handle enter, backspace, delete manually at semantic boundary
* TODO manage cursor for undo redo
